...
<header class="flex justify-between items-center p-6">
  <h1 class="text-5xl text-indigo-900 font-lex font-bold">Kanban Board</h1>

  <button
    class="px-4 py-2 bg-indigo-900 text-white font-lex font-semibold rounded-2xl shadow hover:bg-indigo-800 transition-colors"
...
<main class="min-h-[70vh] bg-indigo-900 p-6 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
  {#each lanes as lane}
    <section class="flex flex-col bg-white rounded-2xl shadow-sm overflow-hidden">
      <header class="bg-gray-100 text-center py-3 font-lex font-semibold border-b border-gray-200">
